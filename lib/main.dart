...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ScreenUtilInit(
      // Design size - Tasarım dosyanızın boyutları (genellikle Figma/Sketch'ten alınır)
      designSize: const Size(360, 800),
      // Minimum text adaptasyonu - Küçük ekranlarda text'lerin çok küçülmesini önler
      minTextAdapt: true,
      // Split screen mode - Tablet ve telefonlarda dikey scaling yapılmasını sağlar
      splitScreenMode: true,
      // Use inherited media query - Tüm cihazlarda (telefon, tablet) dikey scaling yapılmasını garanti eder
      useInheritedMediaQuery: true,
      // Use builder ile MaterialApp'i sarmalıyoruz
      builder: (context, child) {
        return MaterialApp(
          ...
          // Dikey ölçekleme için flutter_screenutil kullanılıyor
